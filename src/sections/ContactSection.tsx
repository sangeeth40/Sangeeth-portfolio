      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-slate-400 mb-12 max-w-xl mx-auto leading-relaxed">
            I'm always interested in discussing AI projects, collaboration
            opportunities, or just having a conversation about technology.
          </p>
